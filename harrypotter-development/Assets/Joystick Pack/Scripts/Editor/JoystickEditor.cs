...
public class JoystickEditor : Editor
{
    ...
    private SerializedProperty isMovement;
    ...
    protected virtual void OnEnable()
    {
        ...
        isMovement = serializedObject.FindProperty("isMovement");
    }
    ...
    protected virtual void DrawValues()
    {
        ...
        EditorGUILayout.PropertyField(isMovement, new GUIContent("Is Movement", "Is this Joystick a movement or skill."));
    }
